...
export const MOCK_SPOTS: SpotMarker[] = [
  ...
  { id: "2", price: 8, type: "garage", available: true, hasEV: true, hasSecurity: true, address: "Drottninggatan 40, Örebro", rating: 4.9, distance: "4 min walk", lat: 59.2770, lng: 15.2060, image: spotImages.underground, host: HOSTS[1] },
  { id: "3", price: 3, type: "driveway", available: true, hasEV: false, hasSecurity: false, address: "Kungsgatan 8, Örebro", rating: 4.2, distance: "6 min walk", lat: 59.2730, lng: 15.2180, image: spotImages.privateGarage, host: HOSTS[2] },
  ...
  { id: "5", price: 6, type: "lot", available: true, hasEV: false, hasSecurity: true, address: "Fabriksgatan 22, Örebro", rating: 4.5, distance: "8 min walk", lat: 59.2710, lng: 15.2050, image: spotImages.office, host: HOSTS[4] },
  ...
  { id: "9", price: 4, type: "driveway", available: true, hasEV: false, hasSecurity: false, address: "Nygatan 25, Örebro", rating: 4.1, distance: "10 min walk", lat: 59.2720, lng: 15.2230, image: spotImages.office, host: HOSTS[2] },
  { id: "10", price: 9, type: "lot", available: true, hasEV: false, hasSecurity: true, address: "Engelbrektsgatan 7, Örebro", rating: 4.6, distance: "5 min walk", lat: 59.2800, lng: 15.2080, image: spotImages.underground, host: HOSTS[1] },
